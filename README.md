...
```javascript
forEachRight = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-for-each-right@v0.1.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/string-base-for-each-right@v0.1.2-umd/browser.js"></script>
```
